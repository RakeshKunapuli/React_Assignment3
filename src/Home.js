    ...
    return (
      <>
        <div className="w-50 mx-auto">
          <input
            className=" container-fluid mt-5 mb-4 placeholder-center text-center text-capitalized"
            type="text"
        ...
        <Movielist movies ={this.state.searchResults.length > 0 ? this.state.searchResults : this.state.movies  }/>
